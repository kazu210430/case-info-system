...
- TaskPane 系
  ...
  - 現在は `TaskPaneDisplayCoordinator`、`TaskPaneRefreshOrchestrationService`、`TaskPaneRefreshCoordinator`、`CasePaneSnapshotRenderService`、`CasePaneCacheRefreshNotificationService`、`TaskPaneActionDispatcher` などへ主責務が分離されています。
- Infrastructure 系
